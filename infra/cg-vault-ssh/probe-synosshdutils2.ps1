...
$r = Invoke-SSHCommand -SessionId $session.SessionId -Command "echo '$ea' | sudo -S find /usr -name synosshdutils 2>/dev/null; echo '$ea' | sudo -S /usr/syno/bin/synosshdutils 2>&1 | head -30" -TimeOut 60
