...
$r = Invoke-SSHCommand -SessionId $session.SessionId -Command "echo '$ea' | sudo -S find /usr/syno/sbin /usr/syno/bin -maxdepth 1 -type f 2>/dev/null | xargs -I{} basename {} | grep -iE 'priv|ssh|terminal|app' | sort -u" -TimeOut 60
