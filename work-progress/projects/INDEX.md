...
| `wsl-mcp-cursor-doppler-promptops-hardening-v1` | [2026-08-02_wsl-mcp-cursor-doppler-promptops-hardening-v1.md](./2026-08-02_wsl-mcp-cursor-doppler-promptops-hardening-v1.md) | **Ledger seed slice PASS; Wave 4 repair package scoped** | `CG-AppBuilder-MCP`, Cursor MCP, Doppler, GitHub Actions | Cross-Agent `5ddd274`; Supabase event `5b090a49...`; AppBuilder PR #267 merged; Revu PR #5 merged | Implement A+B+C+`mcp:repair:cursor`; reopen Cursor from ext4; handle Vercel / Cloudflare / `mcp:attest` separately |
...
| `wsl-mcp-cursor-doppler-promptops-hardening-v1` | Ledger seed slice PASS; Wave 4 repair package scoped | Implement A+B+C+`mcp:repair:cursor`; reopen Cursor from ext4 WSL root, reload MCP, investigate Vercel auth / Cloudflare / `mcp:attest` separately |
| `active-ledger-drain-and-intelligence-hub-sync-v1` | Phases 0–3 complete | Phase 5 material closeout |
