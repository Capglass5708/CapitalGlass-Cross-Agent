...
| --- | --- | --- | --- | --- | --- |
| `workflow-estate-hot-cache-shipped-v1` | HARVEST_COMPLETE | PASS | CapitalGlass-Cross-Agent | [workflow-estate-hot-cache-v1.md](./workflow-estate-hot-cache-v1.md) | None — workflow-estate on main; republish hot cache when operator confirms |
| `harvest-prompt-post-merge-acceptance-v1` | DOCUMENTED | PASS | CapitalGlass-Cross-Agent | [workflow-estate-hot-cache-v1.md](./workflow-estate-hot-cache-v1.md) | Operator approval required before prompt catalog projection |
| `workflow-estate-scout-routing-keywords-v1` | DOCUMENTED | PASS | CapitalGlass-Cross-Agent | [workflow-estate-hot-cache-v1.md](./workflow-estate-hot-cache-v1.md) | None — merged on main |
