...
| --- | --- | --- | --- | --- | --- |
| `2026-08-04-chatgpt-full-autopsy-v1` | VALIDATION_PENDING | HOLD | CapitalGlass-Cross-Agent | docs/protocols/chat-thread-closeout-autopsy-harvest-chatgpt-v1.md | harvest:duplication-preflight → validate → operator publish |
