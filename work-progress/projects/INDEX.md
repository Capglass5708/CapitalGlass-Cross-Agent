...
| --- | --- | --- | --- | --- | --- |
| `WESLEYDESK_DIRECT_CONNECT_EXECUTION_V1` | [2026-09-09_wesleydesk-direct-connect-execution-v1.md](./2026-09-09_wesleydesk-direct-connect-execution-v1.md) | **REGISTERED_PENDING_HOST_ACTIVATION** — not READY/ONLINE/executable; PASS only at INDEXED_READY | CapitalGlass-Office-Admin (catalog/routing), CapitalGlass-Cross-Agent (Git pointer) | this branch | CG-WESLEYDESK-01 host activation; do not dispatch to Ryzen |
...
| `ryzen9desk-wsl2-canonical-workspace-v1` | [2026-08-03_ryzen9desk-wsl2-canonical-workspace-v1.md](./2026-08-03_ryzen9desk-wsl2-canonical-workspace-v1.md) | **IN_PROGRESS** — vscode-automation GHA PASS `33933473045` | `CG-AppBuilder-MCP`, RYZEN9DESK | AppBuilder **`1346d1415`** | RDP confirm VS Code UI; headless Claude `claude40:front-door` |
