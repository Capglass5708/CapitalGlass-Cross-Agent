...
| --- | --- | --- | --- | --- | --- |
| `operational-publish-friction-v1` | HARVEST_COMPLETE | PASS | CapitalGlass-Cross-Agent | artifacts/agent-runs/harvest-2026-08-04-operational-publish-friction-v1/HARVEST_SUMMARY.md | Operator: harvest:publish-intelligence-full when ready |
| `ingest-git-mutation-operational-v1` | DOCUMENTED | PASS | CG-AppBuilder-MCP | artifacts/agent-runs/harvest-2026-08-04-operational-publish-friction-v1/thread-event-inventory.json | Run ledger sync only on clean git; use --skip-ledger-sync when drift-probe IN_SYNC |
| `index-freshness-receipt-treadmill-v1` | DOCUMENTED | PASS | CapitalGlass-Cross-Agent | scripts/index/freshness-gate.mjs | One index:publish at stable HEAD; avoid republish loop after each receipt commit |
| `harvest-render-index-operational-gate-v1` | FIXED | PASS | CapitalGlass-Cross-Agent | scripts/harvest/lib/publish-intelligence-full-lib.mjs | None — render-index stage wired in publish-intelligence-full-lib |
