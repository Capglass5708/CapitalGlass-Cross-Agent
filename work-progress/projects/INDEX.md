...
| `chatgpt-share-fetch-v1` | Parsing/orchestration proven (10/10 tests); live fetch blocked by a real 403 from `chatgpt.com` | Wesley to supply one real share link to test against; resolves whether plain HTTP fetch can work at all or a headless-browser dependency (Playwright, already available in this environment) needs an explicit go-ahead |
