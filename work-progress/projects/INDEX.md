...
| --- | --- | --- | --- | --- | --- |
| `scraper-data-extraction-improvements-v1` | [2026-08-05_scraper-data-extraction-improvements-v1.md](./2026-08-05_scraper-data-extraction-improvements-v1.md) | **ACTIVE** — Waves A–E implemented; e2e proof pending | Scraper, Data-Extraction, CG-MASTER-GRAPH, Cross-Agent | In progress on `feat/scraper-data-extraction-improvements-v1` | Run `npm run scraper-de:e2e-proof`; record final gate |
