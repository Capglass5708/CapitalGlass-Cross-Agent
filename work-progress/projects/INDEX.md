...
| --- | --- | --- | --- | --- | --- |
| `cg-federated-repo-index-v1` | [2026-08-12_cg-federated-repo-index-v1.md](./2026-08-12_cg-federated-repo-index-v1.md) | **CG_FEDERATED_REPO_INDEX_WAVE_A_CLOSED / LIVE_RYZEN9_PROOF_PASS** — blocker `BLOCKED_GHA_WP_NOT_ALLOWLISTED`; failover `DIRECT_CONNECT_FAILOVER_LOCAL` | `CG-AppBuilder-MCP`, `Computer Estimator` | AppBuilder `94c2caae0abe064bfe561ef9ca7e7a79a7ba3d3f`; CE `acc4e2b6` | RYZEN9DESK Remote-WSL: bind WaveRunner continuation and execute complete remaining Wave A through terminal acceptance. CLOSE if PASS. STOP before Wave B. Do not treat generate CLI as the mission. |
...
| Project ID | Status | Next action |
| --- | --- | --- |
| `cg-federated-repo-index-v1` | **IMPLEMENTED_PUSHED / LIVE_RYZEN9_PROOF_PASS** | RYZEN9DESK generate receipt; defer GHA/SSH to `ryzen9desk-executor-transport-repair-v1` |
...
| Project ID | Status | Next action |
| --- | --- | --- |
| `cg-federated-repo-index-v1` | **LIVE_RYZEN9_PROOF_PASS** | Generate local index on RYZEN9DESK Vision Plane bytes; do not compound fake paths on WesleyWork |
