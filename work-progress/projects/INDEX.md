...
| `wesleywork-z-l-pr-merge-publication-closeout-v1` | [wesleywork-z-l-pr-merge-publication-closeout-v1.md](./wesleywork-z-l-pr-merge-publication-closeout-v1.md) | **NEXT** — Phase B durable; merge/publication gates open | CapitalGlass-Office-Admin, CG-AppBuilder-MCP, CapitalGlass-Cross-Agent | Phase B `2508dff55…` on L | Phase C pointer; CI waive/fix; merge #53/#280/#7; WESLEYDESK `index-publication.yml`; four-query L Catalog = YES |
| `z-drive-disconnect-recurrence-v1` | [2026-08-02_z-drive-disconnect-recurrence-v1.md](./2026-08-02_z-drive-disconnect-recurrence-v1.md) | **CORE SYSTEMS GO** — Phase B harvest durable; first-read closeout pending | CapitalGlass-Office-Admin | PR #53 open | Do not reopen drive repair; run closeout mission for ALL SYSTEMS GO |
