...
| --- | --- | --- | --- | --- | --- |
| `ryzen9desk-managed-executor-v1` | [2026-08-03_ryzen9desk-managed-executor-v1.md](./2026-08-03_ryzen9desk-managed-executor-v1.md) | **Active — Phase 0 scaffolded** | `CG-AppBuilder-MCP`, RYZEN9DESK operator | Scaffold on WESLEY_WORK | Install self-hosted runner on RYZEN9DESK; dispatch `executor-smoke`, then `wsl2-canonical-setup` |
