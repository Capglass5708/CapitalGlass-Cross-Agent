...
| `ryzen9desk-wsl2-canonical-workspace-v1` | [2026-08-03_ryzen9desk-wsl2-canonical-workspace-v1.md](./2026-08-03_ryzen9desk-wsl2-canonical-workspace-v1.md) | **IN_PROGRESS** — dev-env parity PASS; vscode fix `94c71cca2` on AppBuilder `main` | `CG-AppBuilder-MCP`, RYZEN9DESK | AppBuilder **`94c71cca2`** | Re-dispatch `vscode-automation`; RDP for VS Code Claude panel |
